...
struct i2c_board_info m7wl_camera_i2c_boardinfo_ov4688_s5k6a2ya[] = {
...
void __init m7wl_init_cam(void)
{
	...
	if ( (((engineerid&1)==0) && (system_rev < 2)) ||
		...
		if (main_camera_id == CAMERA_SENSOR_ID_ST_4M) {
			...
			i2c_register_board_info(APQ_8064_GSBI4_QUP_I2C_BUS_ID,
				m7wl_camera_i2c_boardinfo_ov4688_s5k6a2ya,
				ARRAY_SIZE(m7wl_camera_i2c_boardinfo_ov4688_s5k6a2ya));
			update_yushanII_flag(HTC_CAMERA_IMAGE_YUSHANII_BOARD);
		}
		else {
